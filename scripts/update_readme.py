...
TECH_BADGES = {
    ...
    "Swift": {"category": "Languages", "color": "F05138", "logo": "swift", "logoColor": "white"},
    ...
    "SwiftUI": {"category": "Frontend", "color": "0091FF", "logo": "swift", "logoColor": "white"},
    ...
    "watchOS": {"category": "Infra", "color": "000000", "logo": "apple", "logoColor": "white"},
...
def update_readme(projects_data):
    ...
    # Pattern 2: HTML <!-- PROJECTS --> block — anchored to the "// projects" header
    # to avoid matching the tech stack div which uses the same padding style
