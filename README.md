...
<div style="padding:12px 3% 10px;border-bottom:1px solid #1e1e1e">
<h3 style="margin:0;white-space:nowrap;font-size:1em"><span style="color:#00e5a0">// </span>projects &nbsp;<span style="font-size:13px;font-weight:400;color:#444">· 17 repos · ~468K lines</span></h3>
</div>
...
<img src="https://cryptopilot.dev/projects/watchcontrol/assets/preview.png?v=2" width="100%" alt="watch-control preview" />
</a>
<br>
